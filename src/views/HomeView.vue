...
// ADDED FUNCTION FROM HomeView_extension.ts 
// vicino agli altri import
import { setupHomeViewExtension } from './HomeView_extension'

const {
  // state/refs usati nel template
  boxAddTag,
  boxPrompt,
  loadingStatus,
  statusError,
  ...
  // opzionale
  autofillTextarea,
} = setupHomeViewExtension(userMessage)
