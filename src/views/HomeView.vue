					...
					<ul tabindex="0" class="dropdown-content join join-vertical !left-0 z-10 mb-6 w-48 p-0 [&>li>*]:bg-base-100">
						<li>
							<button
								...
								<span class="grow">Export conversation - modificato</span>
							</button>
						</li>
						<li>
							<button
								...
								<span class="grow">Upload memories - modificato</span>
							</button>
						</li>
						<li>
							<button
								...
								<span class="grow">Upload url - modificato</span>
							</button>
						</li>
						<li>
							<button
								...
								<span class="grow">Upload file - modificato</span>
							</button>
						</li>
						<li>
							<button class="btn join-item w-full flex-nowrap px-2 text-left font-medium" @click="wipeHistory()">
								...
								<span class="grow">Clear conversation - modificato</span>
							</button>
						</li>
					</ul>
				</div>
